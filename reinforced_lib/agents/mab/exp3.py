...
class Exp3(BaseAgent):
    ...
    the value, the more the agent explores. The implementation is inspired by the work of Auer et al. [8]_. There
    ...
    References
    ----------
    .. [8] Peter Auer, Nicolò Cesa-Bianchi, Yoav Freund, and Robert E. Schapire. 2002. The Nonstochastic Multiarmed
