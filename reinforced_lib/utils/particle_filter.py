...
def effective_sample_size(state: ParticleFilterState, threshold: Scalar = 0.5) -> bool:
    r"""
    Calculates the effective sample size [2]_ (ESS). If ESS is smaller than the number of sample times threshold,
    ...
    References
    ----------
    .. [2] https://en.wikipedia.org/wiki/Effective_sample_size#Weighted_samples
    """
